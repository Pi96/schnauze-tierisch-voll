      ...
      {list.map(p => (
        <div key={p.name} className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {p.links?.instagram && (
              <a href={p.links.instagram} target="_blank" className="underline">IG</a>
            )}
            {p.links?.tiktok && (
              <a href={p.links.tiktok} target="_blank" className="underline">TT</a>
            )}
            {p.links?.facebook && (
              <a href={p.links.facebook} target="_blank" className="underline">FB</a>
            )}
          </div>
        </div>
      ))}
